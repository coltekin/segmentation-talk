\begin{frame}
\frametitle{Combining multiple measures: a simple method}

Majority voting (algorithm) works if
\begin{enumerate}
\item Votes are cast (relatively) independently.
\item Decisions of the voters are better than random.
\end{enumerate}
